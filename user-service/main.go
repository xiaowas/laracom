...
import (
	...
	database "github.com/xiaowas/laracom/user-service/db"
	"github.com/xiaowas/laracom/user-service/handler"
	pb "github.com/xiaowas/laracom/user-service/proto/user"
	repository "github.com/xiaowas/laracom/user-service/repo"
	"github.com/xiaowas/laracom/user-service/service"
	"log"
)
